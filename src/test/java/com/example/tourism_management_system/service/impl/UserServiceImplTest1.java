...
class UserServiceImplTest1 {
    ...
    //@Autowired
    UserServiceImplTest1(UserService userService, UserRepository userRepository, UserInTourService userInTourService) {
...
//        String changeEmailResult = userService.changeEmail(email, newEmail);
